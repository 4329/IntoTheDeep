...
@Autonomous(name = "SpecimenAndBasketAuto", group = "1")
public class SpecimenAndBasketAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        SequentialCommandGroup yes = new SequentialCommandGroup(
            ...
            factory.strafeToFirstSample(),
            factory.advanceToSample(),
